...
class KoMAMergeOneLaneEnv(AbstractEnv):
    ...
    def default_config(cls) -> dict:
        ...
        cfg.update({
            ...
            "other_vehicles_count": 2,
            "controlled_vehicles_count": 3,
    ...
    def _make_vehicles(self) -> None:
        ...
        spawn_points_s = [[160, 0], [200, 0], [240, 0], [280, 0]] #150 230 310 460
        ...
        ego_vehicle = self.action_type.vehicle_class(road,
                                                     road.network.get_lane(("b", "c", 1)).position(1, 0),
